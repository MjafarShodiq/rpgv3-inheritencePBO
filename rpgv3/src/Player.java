...
//class Player menjadi turunan dari class Karakter
public class Player extends Karakter{
    //item default yang dimiliki player
    //private Item objCincin = new Item("Cincin Emas"); diganti menjadi objItemAwal di class Karakter
    ...
    tidak digunakan karena method sudah ada di class Karakter
     */
    ...
    public Player() {
        ...
        objItemAwal = new Item("Cincin Emas");//objItemAwal dibuat
        objItemAwal.setDeskripsi("Cincin emas bertuliskan suatu kalimat..");
        arrItem.add(objItemAwal);
    }
