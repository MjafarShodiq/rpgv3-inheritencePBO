...
//menjadi turunan dari class item
public class Pintu extends Item{
    /*
    private ArrayList<String> arrAksi = new ArrayList<>();
    private GameInfo objGameInfo;
    tidak digunakan karena atribut sudah ada di class item
    */

    //constrcutor
    public Pintu() {
        //init pilihan
        super("pintu");//menggunkan super untuk menggunakan constructor Item
        arrAksi.add("Deskripsikan pintu");
        arrAksi.add("Coba buka pintu");
    }

    //memakai @override karena ada method yang sama tetapi isinya beda dengan class Item
    @Override
    ...
    method tidak digunkan karena sudah ada di class Item
     */
