...
public class Ruangan {
    ...
    private Item objPintu;//Diubah menjadi Item objPintu karena turunan dari Item
    private NPC objNPC;
    ...
    public Ruangan() {
        ...
        objPintu = new Pintu();//memakai Polymorphism karana Class Pintu turunan class Item
        objNPC = new NPC();
        ...
        //tambah item ke array tambah juga objPintu menggunakan prinsip Polymorphism
        arrItem.add(objRoti);
        arrItem.add(objPintu);//objPintu dimasukkan ke array
    }
    ...
    public void pilihanAksi() {
        ...
        int subPil;   //aksinya
        int indeks = 0;
        int[] arrUrutPil = new int[2];
        int[] arrSubPil = new int[2];
        ...
        for (String strPil:objPintu.getAksi()) {
            subPil++;
            System.out.printf("%d%d. %s %n", urutPil, subPil, strPil);
        Tidak digunakan karena objPintu dimsukkan ke arrItem sehingga
        kode lebih ringkas
        }*/
        ...
        kondisi pertama tidak digunkan karena sedah masuk ke kondisi
        ke lainnya
        }*/
